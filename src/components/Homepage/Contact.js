...
const Contact = () => {
  ...
  return (
    <section className="min-h-[100vh] snap-start">
      <div className="flex flex-col justify-center items-center w-full h-full gap-16 pt-16 pb-24 bg-[#7d84c8]">
        <div className="flex justify-center items-center flex-grow max-w-[1280px] flex-wrap relative gap-16 px-8">
          <div className="flex flex-col justify-center items-center self-stretch flex-grow">
            <div className="flex flex-col justify-start items-start w-full max-w-[480px] gap-12">
              <div className="flex flex-col justify-start items-start self-stretch  relative gap-5">
                <p className=" w-full max-w-[448px] text-4xl font-semibold text-left text-white">
                  Contact us
                </p>
              ...
              <div className="flex flex-col justify-start items-start self-stretch  gap-8">
                <div className="flex flex-col justify-start items-start self-stretch  gap-6">
                  <div className="flex justify-start items-start self-stretch flex-wrap">
                    <div className="flex flex-col justify-start items-start flex-grow md:basis-1/2 flex-grow flex-shrink-0 md:max-w-1/2 pr-4">
                      <div className="flex flex-col justify-start items-start self-stretch  gap-1.5">
                        <div className="flex flex-col justify-start items-start self-stretch  relative gap-1.5">
                          ...
                          >
                            <div className="flex justify-start items-center flex-grow relative gap-2">
                              <input
                                className="flex-grow max-w-48 w-full text-base text-left text-[#4f4f4f]"
                    ...
                    <div className="flex flex-col justify-start items-start self-stretch  gap-1.5">
                      <div className="flex flex-col justify-start items-start self-stretch  relative gap-1.5">
                        ...
                        >
                          <div className="flex justify-start items-center flex-grow relative gap-2">
                            <input
                              className="flex-grow w-full max-w-[448px] text-base text-left text-[#4f4f4f]"
                  ...
                  <div className="flex flex-col justify-start items-start self-stretch ">
                    <div className="flex flex-col justify-start items-start self-stretch  gap-1.5">
                      <div className="flex flex-col justify-start items-start self-stretch  relative gap-1.5">
                        ...
                        >
                          <div className="flex justify-between items-center self-stretch  relative overflow-hidden pl-4 pr-3 py-3">
                            <p className=" text-base text-left text-[#4f4f4f]">
                              IN
                            </p>
                            <svg
                              width="20"
                          ...
                          <div className="flex justify-start items-center flex-grow relative gap-2 pr-4 py-3">
                            <input
                              className="flex-grow w-[395px] text-base text-left text-[#4f4f4f]"
                              type="tel"
                  ...
                  <div className="flex flex-col justify-start items-start self-stretch h-[74px]">
                  ...
                  <div className="flex justify-start items-center self-stretch  relative gap-3">
                    ...
                    <label className="flex-grow w-full max-w-[448px] text-base text-left">
                      ...
                      <span className="flex-grow w-full max-w-[448px] text-base text-left text-[#667085]">
                        .
                      </span>
                    </label>
                  </div>
                ...
                <div className="flex flex-col justify-start items-start self-stretch  gap-4">
                  <div className="flex justify-start items-start self-stretch  rounded-lg">
                    <button
