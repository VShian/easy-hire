...
const Header = () => {
  return (
    <section className="header min-h-[100vh] snap-start">
      <div className="flex justify-center items-center max-w-[1440px] relative gap-8 px-8 flex-col-reverse md:flex-row">
        <div className="flex flex-col justify-start items-start flex-grow gap-12">
          <div className="flex flex-col justify-start items-start self-stretch  relative gap-6">
            <p className="self-stretch text-5xl font-semibold text-left text-[#333]">
          ...
          <div className="flex justify-start items-start  gap-4">
            <div className="flex flex-col justify-start items-start self-stretch">
              <div className="flex flex-col justify-start items-start self-stretch  relative gap-2">
                <div className="flex justify-start items-start self-stretch  gap-1.5">
                  <div
                  ...
                  >
                    <div className="flex justify-start items-center flex-grow relative gap-2">
                      <input
                        type="email"
                        className="flex-grow text-base text-left text-[#828282]"
